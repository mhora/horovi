...
2. Go to your repository at [mhora/horovi](https://github.com/mhora/horovi).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `horovi.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | horovi.com | The hostname or IP address of your Docker Swarm manager. |
...
- [Backend Tests Workflow](https://github.com/mhora/horovi/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/mhora/horovi/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/mhora/horovi-backend`) and Frontend (`ghcr.io/mhora/horovi-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of horovi.com](https://github.com/mhora/horovi/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/horovi.com.yml` stack.
